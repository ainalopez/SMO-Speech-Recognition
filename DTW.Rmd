...
SpeechRecognizer <- function(isound){
  ...
  # Compute the distance of the input sound with the tenplate sounds
  distance.sound<-rep(NA, 4)
  
  dtwg1 <- TimeWarp(gmail1, inputWord)
  distance.sound[1]<- tail(dtwg1$DTW[,1],1)

  dtwg2 <- TimeWarp(gmail2, inputWord)
  ...
  if (which.min(distance.sound) == 1 | which.min(distance.sound) == 2){
    system(paste("open http://gmail.com"))
  } 
