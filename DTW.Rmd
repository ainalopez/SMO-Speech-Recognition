...
### Derivative DTW
Derivative DTW [A] proposes replacement of the value of each data point with its estimated local first derivation in the process of dynamic time warping. The improvement of the classic DTW is shown in the figure below, as after creating 1) two artificial signals, and identifying 2) the intuitive feature to feature warping alignment, the
alignment produced by classic DTW and the alignment produced by DDTW are sections 3) and 4) respectively.  
...
[A] Keogh, E. J., & Pazzani, M. J. Derivative Dynamic Time Warping
[link](http://www.ics.uci.edu/~pazzani/Publications/keogh-kdd.pdf)
